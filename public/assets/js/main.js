window.addEventListener("load", function () {
	(function () {
		...
		// masonry grid initialization with Isotope
		$('.mry-masonry-grid').isotope({
		...
		// Automatically apply the filter based on the current category page
		$(document).ready(function () {
			...
			// Apply the filter automatically if it matches any category
			if (categoryMap[currentPage]) {
				var selector = categoryMap[currentPage];
				$('.mry-masonry-grid').isotope({
					filter: selector
				});

				// Set the active class on the correct filter tab
